...
final class AuthController extends Controller
{
    ...
    public function sendResetLink(Request $request): RedirectResponse
    {
        ...
        // Токен создаётся брокером только для реально существующего пользователя.
        return back()->with('status', __('Если указанный email зарегистрирован, мы отправили на него ссылку для сброса пароля.'));
    }
