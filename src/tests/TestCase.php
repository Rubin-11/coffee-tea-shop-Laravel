...
abstract class TestCase extends BaseTestCase
{
     ...
     * @return Collection<int, Product> Коллекция созданных товаров
     *
     * @example
     ...
     */
    protected function createProducts(int $count, array $attributes = []): Collection
    {
     ...
     * @return Collection<int, User> Коллекция созданных пользователей
     *
     * @example
     * $users = $this->createUsers(3); // Создать 3 пользователей
     */
    protected function createUsers(int $count, array $attributes = []): Collection
    {
     ...
     * @return Collection<int, Category> Коллекция созданных категорий
     *
     * @example
     * $categories = $this->createCategories(5); // Создать 5 категорий
     */
    protected function createCategories(int $count, array $attributes = []): Collection
    {
