...
- [DATABASE.md](docs/DATABASE.md) - детальная схема базы данных
- [FEATURES.md](docs/FEATURES.md) - список реализованных и планируемых фич
- [PROGRESS.md](docs/PROGRESS.md) - текущий статус разработки
- [API.md](docs/API.md) - API документация (когда появится)
...
**Git репозиторий:** //wsl.localhost/Ubuntu/home/rubin11/projects/coffee-tea-shop-Laravel
