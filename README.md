...
| Документ | Описание |
|----------|----------|
| [📋 ARCHITECTURE.md](ARCHITECTURE.md) | Полная архитектура проекта, технологический стек, паттерны |
...
*(Тесты будут добавлены в следующих версиях)*
...
**Репозиторий:** //wsl.localhost/Ubuntu/home/rubin11/projects/coffee-tea-shop-Laravel  
**Год:** 2026
